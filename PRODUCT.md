...
The consumer-authoring workflow provides composed review, versioned TOON/JSON
results, conventional artifact paths, safe report addition, a conventional
React source contract, and packaged realistic authoring guidance. The accepted
interfaces are recorded in
[D7](docs/decisions/0007-consumer-authoring-contracts.md). They compose the
existing lifecycle and do not move visual design, page composition, numbering,
fit, or reference acceptance into Unslide.
