...
export const operatingReviewData: OperatingReviewData = {
  ...
  regions: [
    {
      ...
      margin: "44.8%",
      plan: "103%",
      commentary: "Enterprise expansion and pricing",
    },
    {
      name: "Europe",
      revenue: "$12.7m",
      ...
      margin: "42.1%",
      plan: "99%",
      commentary: "Stable retention; slower new logo",
    },
    {
      name: "Korea",
      revenue: "$8.1m",
    ...
    },
    {
      ...
      margin: "36.2%",
      plan: "95%",
      commentary: "Service mix remains dilutive",
    },
    {
      name: "Latin America",
      revenue: "$2.7m",
      ...
      margin: "34.7%",
      plan: "91%",
      commentary: "Pricing reset underway",
    },
  ],
  korea: {
  ...
  priorities: [
    {
      owner: "Commercial",
      priority: "Convert enterprise pipeline",
      measure: "$9.5m qualified pipeline",
      timing: "Q3",
      state: "on-track",
    },
    {
      owner: "Customer",
      priority: "Reduce SMB early churn",
      measure: "≤3.2% monthly churn",
      timing: "Q4",
      state: "attention",
    },
    {
      owner: "Operations",
      priority: "Standardize service scope",
      measure: "+120 bps gross margin",
      timing: "Q4",
      state: "on-track",
    },
    {
      owner: "Korea",
      priority: "Scale partner motion",
      measure: "35% partner-sourced mix",
      timing: "Q4",
      state: "on-track",
    },
  ],
  ...
  notes: [
    ...
    {
      label: "Revenue",
      text: "Net revenue after rebates and partner commissions; period values are ready-to-display inputs.",
    },
    {
      label: "NRR",
      text: "Trailing-twelve-month recurring revenue from the opening cohort, including expansion and contraction.",
    },
    { label: "Plan", text: "Performance against the Q2 operating plan approved in January 2026." },
    {
      label: "Rounding",
      text: "Totals may not add due to rounding. Growth and margin values are supplied by the report caller.",
    },
  ],
};
